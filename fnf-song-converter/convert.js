...
function loadFile(file) {
  ...
  reader.onload = (e) => {
    ...
    link.href = url;
    link.innerText = 'Download Beatmap';
    link.download = "beatmap.txt"; // file.name.split(".")[0]
    link.id = "download";

    outputArea.appendChild(link);

    const linkDoc = document.createElement('a');
    linkDoc.href = "https://github.com/cabalex/fnf-song-converter/wiki/"
    linkDoc.text = "Documentation"
    outputArea.appendChild(linkDoc);
  }
